...
<div class="hdr">
<h1 id="dash-title"><span>&#9670;</span> BROADSIDE</h1>
...
<script>
var A='/api';
var RESOURCE='press_releases';
var TITLE_FIELD='title';

var fields=[{"name": "id", "label": "Id", "type": "text"}, {"name": "title", "label": "Title", "type": "text"}, {"name": "body", "label": "Body", "type": "textarea"}, {"name": "contact", "label": "Contact", "type": "text"}, {"name": "status", "label": "Status", "type": "text"}, {"name": "publish_date", "label": "Publish Date", "type": "date"}, {"name": "outlet", "label": "Outlet", "type": "text"}, {"name": "tags", "label": "Tags", "type": "text"}, {"name": "created_at", "label": "Created At", "type": "text"}];
