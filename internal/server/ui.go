...
<title>Stockyard Broadside</title>
<style>
  :root {
    --bg: #1a1410;
    --surface: #241c15;
...
<header>
  ...
  <span style="color:var(--cream);font-weight:600;">Broadside</span>
  <span class="badge">v0.1.0</span>
</header>
<main>
  <div class="hero">
    <h1>Broadside</h1>
    <p>OG image and screenshot API — POST a template, get back a PNG for social cards</p>
  </div>
  <div class="stats">
    <div class="stat">
  ...
  <div class="card">
    ...
    <div class="tier-box">
      <div class="tier">
        ...
        <div class="tier-desc">3 templates, 100 renders/mo</div>
        <div class="tier-price">$0/mo</div>
      </div>
      <div class="tier pro">
        <div class="tier-name">Pro</div>
        <div class="tier-desc">Unlimited templates and renders</div>
